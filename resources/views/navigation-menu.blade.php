        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <h1 class="font-bold text-xl tracking-[1px]">EmPrueba</h1>
                    </a>
                </div>
                ...
                <div class="hidden disable space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="flex gap-3 ms-3">
                    <img src="https://img.icons8.com/?size=100&id=43942&format=png&color=000000" class="w-8 h-8" alt="">
                    <img src="https://img.icons8.com/?size=100&id=87&format=png&color=000000" class="w-8 h-8" alt="">
                    <a href="/cart">
                    <img src="https://img.icons8.com/?size=100&id=9671&format=png&color=000000" class="w-8 h-8" alt="carrito"></a>
